<script setup>
// Import Vue's reactive for form state
import { reactive } from 'vue';
// Import axios for HTTP requests
import axios from 'axios';
// Import router for navigation after job creation
import router from '@/router';
// Import toast for notifications
import { useToast } from 'vue-toastification';
const toast = useToast();

// Reactive form state for job and company info
const form = reactive({
  type: 'Full-Time',
  title: '',
  description: '',
...
// Submit handler for adding a new job
...
<template>
  <!--
    Add Job form with fields for job and company info.
    Submits to API and shows toast notifications.
  -->
